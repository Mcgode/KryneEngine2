...
;
; shader debug name: bc4c5486f5da7404d75556aa2326bb7b.pdb
; shader hash: bc4c5486f5da7404d75556aa2326bb7b
;
; Buffer Definitions:
;
;
...
@"@@rps_ParamDescArray9" = private constant [1 x %struct.RpsParameterDesc] [%struct.RpsParameterDesc { %struct.RpsTypeInfo { i16 36, i16 64 }, i32 0, %0* @"@@rps_ParamAttr8", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"@@rps_Str11", i32 0, i32 0), i32 4 }], align 4
...
@"@@rps_ParamAttr12" = private constant %0 { i32 128, i32 0, i32 35, i32 0 }, align 4
...
@"@@rps_ParamAttr16" = private constant %0 zeroinitializer, align 4
@"@@rps_ParamDescArray17" = private constant [3 x %struct.RpsParameterDesc] [%struct.RpsParameterDesc { %struct.RpsTypeInfo { i16 36, i16 64 }, i32 0, %0* @"@@rps_ParamAttr12", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"@@rps_Str11", i32 0, i32 0), i32 4 }, %struct.RpsParameterDesc { %struct.RpsTypeInfo { i16 4, i16 0 }, i32 0, %0* @"@@rps_ParamAttr14", i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"@@rps_Str13", i32 0, i32 0), i32 0 }, %struct.RpsParameterDesc { %struct.RpsTypeInfo { i16 4, i16 0 }, i32 0, %0* @"@@rps_ParamAttr16", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"@@rps_Str25", i32 0, i32 0), i32 0 }], align 4
...
@"@@rps_ParamAttr20" = private constant %0 { i32 524288, i32 0, i32 0, i32 0 }, align 4
@"@@rps_ParamDescArray21" = private constant [1 x %struct.RpsParameterDesc] [%struct.RpsParameterDesc { %struct.RpsTypeInfo { i16 36, i16 64 }, i32 0, %0* @"@@rps_ParamAttr20", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"@@rps_Str23", i32 0, i32 0), i32 4 }], align 4
...
!1 = !DIFile(filename: ".\5CExternal\5CRenderPipelineShaders\5Cexamples\5Chello_triangle.rpsl", directory: "")
!2 = !{}
!3 = !{!4, !6, !18, !10, !20}
...
!24 = !DIFile(filename: ".\5CExternal\5CRenderPipelineShaders\5Cexamples/___rpsl_builtin_header_.rpsl", directory: "")
